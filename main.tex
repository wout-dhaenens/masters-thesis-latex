...
% TODO: Sizing variable: panel area A_pv* [m^2]  (or number of modules)
% TODO: DC power model: P_DC(t) = (G_POA(t) / G_STC) * P_STC * A_pv* * (1 + gamma_pdc*(T_cell(t)-T_ref))
% TODO: Cell temperature model: T_cell(t) = T_amb(t) + G_POA(t) * NOCT_factor
% TODO: Inverter / DC-AC conversion efficiency eta_inv
% TODO: Upper bound on A_pv* (available roof area of M-accent building)
